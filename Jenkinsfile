...
stage ("running appscan on cloud"){
    // appscan application: '13a06581-eb2c-4b1f-8002-6722126ae44e', credentials: 'asoc', failBuild: true, failureConditions: [failure_condition(failureType: 'high', threshold: 4)], name: 'JPS_test', scanner: static_analyzer('/var/jenkins_home/jobs/JPetStore/workspace'), type: 'Static Analyzer', wait: true
	...
	appscan application: '17969f05-19dd-4143-b7e2-c52a3336db18', credentials: 'asoc', failBuild: true, failureConditions: [failure_condition(failureType: 'high', threshold: 20)], name: '17969f05-19dd-4143-b7e2-c52a3336db185549', scanner: static_analyzer('/var/jenkins_home/jobs/JPetStore/workspace'), type: 'Static Analyzer', wait: true
 }
